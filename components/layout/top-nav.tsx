...
import { FinGraphMark } from "@/components/layout/fingraph-mark";
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-line/70 bg-panel/88 backdrop-blur-xl">
      <div className="mx-auto flex min-h-[72px] w-full max-w-[1840px] flex-wrap items-center gap-3 px-4 py-3 sm:px-5 lg:flex-nowrap lg:px-6">
        <Link href="/" className="flex min-w-[172px] items-center gap-3">
          <FinGraphMark className="h-10 w-10" />
          <span className="text-xl font-semibold tracking-[0.01em] text-text">FinGraph</span>
        </Link>
